...
public class Prjava43montilla24 extends Frame 
   ...
   public Prjava43montilla24 () { 
      ...
      setTitle("nova finestra prjava43montilla24");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava43montilla24();  // Let the construct do the job 
   } 
